...
let fichas=[0,1,2,3,4,5,6,7,8] //creamos un array que almacena las posiciones de las fichas
...
function seleccionar(casilla){
     ...
     if(num_click==1){ //creamos una condicion para iniciar el conteo y registro de los clicks que activara el movimiento de la ficha 
     ...
     if(num_click==2){ //creamos otra condicion para evaluar el segundo click y realizar el intercambio de casillas
        ...
        let intercambio =fichas[primerclic] //creamos una variable de intercambio en la que almacenamos primero la posicion de la imagen en la que hicimos click inicialmente

        fichas[primerclic]=fichas[segundoclic] // hace el reemplazo entre la primera con la segunda

        fichas[segundoclic]=intercambio //la segunda seleccion cambiara con la primera almacenada inicialmente en variable intercambio
...
function quitarborde(){
    ...
    for (let c=0; c<9; c++){ //el iterador buscara en todas las posicion 
...
function desordenar(){
    ...
    fichas=fichas.sort(function(){ //toma el array fichas con las posiciones iniciales y vuelve a reordenar las posiciones del arreglo
...
function moverfichas(){
    ...
    for(let c=0;c<9;c++){ // el iterador buscara en todas las posiciones donde hizo click

        let imagenficha=fichas[c] //en la variable imagenficha almacena el array con la posicion en la que hizo click
...
comprobacion.addEventListener('click',comprobarpuz) //evento de escucha cuando haga click en el boton invocara la funcion comprobarpuz
...
function comprobarpuz(){
    ...
    for(let i=0;i<9;i++){  //recorremos el iterador 

       
      

        if( fichas[i] == i ){ //comprobamos que la posicion i es diferente a la posicion i
